...
namespace RespectTheYield
{
    ...
    [SettingsUIGroupOrder(kEnabledGroup, kButtonGroup, kToggleGroup, kSliderGroup, kDropdownGroup)]
    [SettingsUIShowGroupName(kEnabledGroup, kButtonGroup, kToggleGroup, kSliderGroup, kDropdownGroup)]
    public class Setting : ModSetting
    {
        private readonly PrefixLogger m_Log;
        ...
        {
            m_Log = new PrefixLogger(nameof(Setting));
        }
        ...
        public bool Button { set { m_Log.Info("Button clicked"); } }

        [SettingsUIButton]
        [SettingsUIConfirmation]
        [SettingsUISection(kSection, kButtonGroup)]
        public bool ButtonWithConfirmation { set { m_Log.Info("ButtonWithConfirmation clicked"); } }
    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            ...
            {
                { m_Setting.GetSettingsLocaleID(), "RespectTheYield" },
                { m_Setting.GetOptionTabLocaleID(Setting.kSection), "Main" },

                { m_Setting.GetOptionGroupLocaleID(Setting.kEnabledGroup), "Mod" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.ModEnabled)), "Enable RespectTheYield" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.ModEnabled)), "Toggle the mod on or off." },
